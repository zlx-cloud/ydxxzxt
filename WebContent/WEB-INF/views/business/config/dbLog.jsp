...
<script type="text/javascript">
	function searchDbLog() {
		...
		$('#dg').datagrid('options').url = '${ctx}/dbLog/list';
		$('#dg').datagrid('load', {
			bwbsSearch : $("#bwbsSearch").val(),
	...
	function hsBar(varId) {
		...
		$.ajax({
			type : "post",
			url : "${ctx}/dbLog/jshs?diff3Time=" + diff3Time
...
<body style="margin: 1px;">
	<table id="dg" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
		url="${ctx}/dbLog/list?startTimeSearch=${startTime}&endTimeSearch=${endTime}&fwqqzZcxxSearch=A00100000000000100003" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			&nbsp;报文标识：&nbsp;
			<input type="text" class="easyui-textbox" name="bwbsSearch" id="bwbsSearch" size="20" />
			&nbsp;应用名称：&nbsp; 
			...
			&nbsp;请求内容：&nbsp;
			<input type="text" class="easyui-textbox" name="keyWordRequestSearch" id="keyWordRequestSearch" size="20" />
			&nbsp;响应内容：&nbsp;
			<input type="text" class="easyui-textbox" name="keyWordResponseSearch" id="keyWordResponseSearch" size="20" />
			&nbsp;响应状态&nbsp;
			...
			<a href="javascript:searchDbLog()" class="easyui-linkbutton" 
				iconCls="icon-search" plain="true">查询</a>
			<a href="${ctx}/dbLog/dbLogExport" class="easyui-linkbutton"
