...
<script type="text/javascript">
	...
	function openAddView() {
		...
		$("#addUpdate").dialog("open").dialog("setTitle", "添加访问频度配置");
		url = "${ctx}/configAccessFrequency/add?flag=1";
	}
	...
	function deleteConfig() {
		...
		$.messager.confirm("系统提示", "您确认要删除这条数据吗？", function(r) {
			if (r) {
				$.post("${ctx}/configAccessFrequency/delete", {
					id : id
				}, function(result) {
					if (result.success) {
...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<table id="dg" class="easyui-datagrid" fitColumns="true" singleSelect="true"
			pagination="true" rownumbers="true" url="${ctx}/configAccessFrequency/list" fit="true" toolbar="#tb">
			<thead>
				<tr>
			...
			<form id="addUpdatefm" method="post">
				<table cellspacing="5px;">
					...
					<tr>
						<td>时长（秒）：</td>
						<td>
							<input type="text" id="duration" name="duration" class="easyui-textbox"/>
						</td>
						<td>访问次数：</td>
						<td>
