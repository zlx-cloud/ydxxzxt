...
<body class="easyui-layout">
			  ...
			  series: [
			    {
			      ...
			      data: [
			        { value: ${count1}, name: '请求时间变长' },
			        { value: ${count2}, name: '失败率' },
			        { value: ${count3}, name: '缺少包' }
			      ]
			    }
			  ]
			};
	...
	function searchDbLog() {
		...
		option1.series[0].data[2].value='';
		$.ajax({
			type : "post",
			url : "${ctx}/temporary/warnChartSearch?yybs=" + $("#fwqqzZcxxSearch").val()
			...
			success : function(data) {
				...
				option1.series[0].data[0].value=data[4];
				option1.series[0].data[1].value=data[5];
				option1.series[0].data[2].value=data[6];
			}
		})
		myChart.setOption(option);
		myChart1.setOption(option1);
