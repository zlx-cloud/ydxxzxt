...
<script type="text/javascript">
	...
	function searchConfig() {
		...
		$('#dg').datagrid('options').url='${ctx}/temporary/yjxxcx';
		$('#dg').datagrid('load', {
			yymc : $("#yymcIndex").val(),
			fwmc : $("#fwmcIndex").val(),
			ffmc : $("#ffmcIndex").val(),
	...
	function showList(FWBS,FFBS) {
		...
		options.url = "${ctx}/temporary/warnEsLog1";
...
<body class="easyui-layout">
	<div data-options="region:'center'">
		<table id="dg" class="easyui-datagrid" fitColumns="true" singleSelect="true"
			pagination="true" rownumbers="true" url="${ctx}/temporary/yjxxcx?startTime=${time}&endTime=${time}" fit="true" toolbar="#tb">
			<thead>
				<tr>
