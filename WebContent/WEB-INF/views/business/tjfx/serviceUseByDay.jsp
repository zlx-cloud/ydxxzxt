...
<%-- <table id="dg" title="服务日调用量统计" class="easyui-datagrid" fitColumns="true"
    pagination="true" rownumbers="true" url="${ctx}/monitoring/queryServiceUseByDayGrid" fit="false" >
    <thead>
    	<tr>
