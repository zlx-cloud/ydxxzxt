...
<body class="easyui-layout" >
          ...
          <table id="dg"  class="easyui-datagrid" fitColumns="true"  singleSelect="true" pagination="true" rownumbers="true" url="${ctx}/fwFFqqcsManage/listHis?fwbs=${fwbs}" fit="true" toolbar="#tb">
                <thead>
                    <tr>
    		     ...
    		     <th field="ffmc"  align="center">方法名</th>
    		      ...
    		      <th field="qqcsm"  align="center">请求参数名</th>
	...
	<div>
		...
		<a href="javascript:searchFwzyFFqqcshis()" class="easyui-linkbutton" iconCls="icon-search" plain="true">查询</a>
